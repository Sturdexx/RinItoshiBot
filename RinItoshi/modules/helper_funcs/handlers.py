...
import RinItoshi.modules.sql.blacklistusers_sql as sql
from RinItoshi import LOGGER, DEV_USERS, SUPPORT_USERS, WHITELIST_USERS

try:
    from RinItoshi import CUSTOM_CMD
