...
import RinItoshi.modules.helper_funcs.fun_strings as fun
from RinItoshi import LOGGER, DEV_USERS, SUPPORT_USERS, dispatcher
from RinItoshi.modules.disable import (
    DisableAbleCommandHandler,
    DisableAbleMessageHandler,
)
from RinItoshi.modules.helper_funcs.alternate import typing_action
from RinItoshi.modules.helper_funcs.extraction import extract_user
...
*Regex based memes:*
`/decide` (disabled rn) can be also used with regex like: `RinItoshi What? <question>: randomly answer "Yes, No" etc.`
Some other regex filters are:
`me too` | `good morning` | `good night`.

RinItoshi will reply random strings accordingly when these words are used!
...
# DECIDE_HANDLER = DisableAbleMessageHandler(Filters.regex(r"(?i)(RinItoshi)"), decide, friendly="decide", run_async=True)
