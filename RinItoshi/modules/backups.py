...
# from RinItoshi.modules.sql import warns_sql as warnssql
import RinItoshi.modules.sql.blacklist_sql as blacklistsql

# from RinItoshi.modules.sql import cust_filters_sql as filtersql
# import RinItoshi.modules.sql.welcome_sql as welcsql
import RinItoshi.modules.sql.locks_sql as locksql
import RinItoshi.modules.sql.notes_sql as sql

# from RinItoshi.modules.rules import get_rules
import RinItoshi.modules.sql.rules_sql as rulessql
from RinItoshi import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from RinItoshi.__main__ import DATA_IMPORT
from RinItoshi.modules.connection import connected
from RinItoshi.modules.helper_funcs.alternate import typing_action
from RinItoshi.modules.helper_funcs.chat_status import user_admin
from RinItoshi.modules.sql import disable_sql as disabledsql
...
def export_data(
    ...
    with open("RinItoshi{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("RinItoshi{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `RinItoshi-Backup` "
    ...
    os.remove("RinItoshi{}.backup".format(chat_id))  # Cleaning file
