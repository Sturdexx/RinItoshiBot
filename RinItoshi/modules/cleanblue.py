...
from RinItoshi import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from RinItoshi.modules.sql import cleanblue_sql as sql
...
× /gignoreblue <word>: Globally ignore bluetext cleaning of saved word across RinItoshi.
