...
from RinItoshi import LOGGER, TOKEN, dispatcher
from RinItoshi.modules.helper_funcs.chat_status import dev_plus
...
def do(func, update, context):  # skipcq
    ...
    os.chdir(os.getcwd())
    with open(
        os.path.join(os.getcwd(), "RinItoshi/modules/helper_funcs/temp.txt"),
        "w",
    ) as temp:
        temp.write(body)
