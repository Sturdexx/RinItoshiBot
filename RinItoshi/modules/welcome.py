...
import RinItoshi.modules.sql.welcome_sql as sql
...
from RinItoshi.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from RinItoshi.modules.helper_funcs.misc import build_keyboard, revert_buttons
from RinItoshi.modules.helper_funcs.msg_types import get_welcome_type
from RinItoshi.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from RinItoshi.modules.log_channel import loggable
from RinItoshi.modules.no_sql.gban_db import is_user_gbanned
                ...
                update.effective_message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton(
                                    text="☎️ Support", url="https://t.me/BlueLockSupport"
                                ),
                                InlineKeyboardButton(
                                    text="Updates 📡", url="https://t.me/RinItoshiUpdates"
                                ),
                            ]
                        ],
                    ),
